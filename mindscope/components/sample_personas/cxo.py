...
CHIEF_FINANCIAL_OFFICER = Persona(
...
CHIEF_MARKETING_OFFICER = Persona(
...
CHIEF_STRATEGY_OFFICER = Persona(
    ...
    traits={
        ...
        "big_picture_thinker": True,
    },
)

CHIEF_INFORMATION_SECURITY_OFFICER = Persona(
...
CHIEF_TECHNOLOGY_OFFICER = Persona(
